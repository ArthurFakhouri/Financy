### 🌐 PT-BR
#### [EN-US](https://github.com/ArthurFakhouri/Financy/blob/master/READMEEN.md)
...
## 🈸 Projeto
O projeto é um site desktop de organização de finanças, com gestão de transações e categorias.
...
- 01 - ```cd backend```
- 02 - ```npm i```
- 03 - Configure as variáveis de ambiente em um arquivo .env (Siga o exemplo do arquivo .env.example)
- 04 - ```npm run dev```
